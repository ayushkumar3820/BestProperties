...
export default function Rent() {
  ...
  const clearFilters = () => {
    ...
    setSelectedPropertType([]);
    setRangeValues({ min: 0, max: 40000 });
    setSortBy("");
    setSelectedLocation("");
  };
  ...
  const filterPanelsByBudget = (panel) => {
    ...
    const hasAtLeastOneSelectedAmenity = selectedAmenities.length
      ? selectedAmenities.some((amenity) => panelAmenities.includes(amenity))
      : true;
    const hasAtLeastOne = selectedPropertyType.length
            ...
            <div className="bg-white p-2 lg:shadow-md flex flex-col lg:flex-row items-center gap-2 flex-wrap lg:flex-nowrap">
              <div className="flex flex-col lg:flex-row items-center gap-2 min-n-[200px]">
                ...
                <div className="checkbox-dropdown bg-white border-2 border-green-600 p-3 text-lg rounded-md h-11 w-full lg:w-1/4 min-w-[200px] relative">
                  ...
                  >
                    {selectedPropertyType.length > 0 ? (
                      ...
                      <div className="flex gap-2 justify-between items-center w-full">
                        <div className="truncate">Select Property</div>
                        <svg
                          fill="black"
                  ...
                  {isOpen && (
                    <div className="absolute top-full left-0 bg-white border border-green-600 rounded-md mt-1 z-10 w-full">
                                ...
                                <div className="mt-4">
                                  ...
                                  {panel.security_deposite && (
                                    <div className="flex items-center justify-center gap-2">
                                      ...
                                      <div>{panel.security_deposite}</div>
                                    </div>
                                  )}
                                  <div className="flex justify-center items-center">
                                    <button
