...
const projectData = [
  {
    ...
    title: "Joy Grand",
    location:
      "court complex, Sector 88, Sahibzada Ajit Singh Nagar, Punjab 140307",
...
const projects = [
  ...
  },
  {
    name: "Wave Estate",
    address:
      "2,3,4,5 BHK Independent/Builder Floor, Apartment,Independent House/Villa, Sector 85",
    price: "50,000,000",
    image: "https://images.unsplash.com/photo-1599423300746-b62533397364", // Dummy image
  },
  {
...
const Projects = () => {
  ...
  const { image, title, location, apartmentType, price } =
