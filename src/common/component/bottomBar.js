...
export default function BottomBar() {
  ...
  // Split the disclaimer text to show only the first two lines initially
  ...
  return (
    <div className="relative">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed left-5 bottom-10 z-10"
      >
        <button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-[#002C35] shadow dark:bg-gray-900">
        <div className="w-full">
          ...
          <div className="border-white border-dotted border-t-2 dark:border-gray-700 mt-2 line-clamp-2"></div>
          <span class="block text-sm p-2 text-white sm:text-center dark:text-gray-400 mt-4 mx-auto py-4 line-clamp-2">
            {initialLines}
            <Link
              to="/diclaimer"
