...
export default function AboutProperty() {
  ...
  const validateForm = () => {
    ...
    if (propertyAction === "Rent/Lease") {
      ...
      errors.propertyAction = "Invalid property action";
    }
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      available_from: selectedDate.toISOString(),
      token,
    };
    ...
    try {
      ...
      if (data.status === "done") {
        ...
        setSubmissionStatus("error");
        setErrorMessage(data.message || "Failed to submit property details. Please try again.");
      }
    } catch (error) {
      console.error("Submission error:", error);
      setSubmissionStatus("error");
      setErrorMessage("An error occurred while submitting. Please check your connection and try again.");
    } finally {
      setLoader(false);
    }
  };
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          {submissionStatus === "success" ? (
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">Your property details have been submitted. Redirecting...</p>
            </div>
          ) : (
            <>
