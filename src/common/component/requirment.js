  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-8 px-4">
        <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-1">
          ...
          <div className="flex justify-center mb-6">
            <div
              ...
              className="bg-red-600 w-full max-w-md flex justify-center p-3 rounded-full cursor-pointer hover:bg-red-700 transition-colors"
            >
              {loader ? (
                <svg
